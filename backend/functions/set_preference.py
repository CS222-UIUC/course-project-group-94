...
def set_preference(calories, sugarDiet, biologicalSex, protein, carbs, sodium, iron, username):
    calories, sugLow, sugUpp, fatLow, fatUpp, protein, carbs = dietPreferenceReader(calories, sugarDiet, biologicalSex, protein, carbs)
