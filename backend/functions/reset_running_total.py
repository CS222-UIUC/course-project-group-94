...
#function that sets all values in all columns of running total to 0 except username
...
#continuously running script that checks if the date has changed every hour, if so then call resetRunningTotal
currdate = date.today()
while True:
